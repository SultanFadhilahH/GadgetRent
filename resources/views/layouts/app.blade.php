                ...
                <nav class="p-4 space-y-6">
                    <div>
                        ...
                        <ul class="space-y-1">
                            ...
                            <li>
                                <a href="{{ route('gadgets.index') }}" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->routeIs('gadgets.*') ? 'bg-[#222632] text-white border-l-4 border-amber-500 rounded-l-none' : 'text-gray-400 hover:bg-[#222632] hover:text-white transition' }}">
                            ...
                            <li>
                                <a href="{{ route('rentals.index') }}" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->routeIs('rentals.*') ? 'bg-[#222632] text-white border-l-4 border-amber-500 rounded-l-none' : 'text-gray-400 hover:bg-[#222632] hover:text-white transition' }}">
