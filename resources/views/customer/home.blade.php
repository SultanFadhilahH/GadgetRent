...
<body class="font-sans antialiased bg-[#12141c] text-gray-200 flex flex-col min-h-screen">
    ...
    <nav class="border-b border-gray-800 bg-[#12141c] py-4 px-6 md:px-12 flex justify-between items-center sticky top-0 z-50">
        ...
        <div class="hidden md:flex gap-8 text-sm font-medium text-gray-400">
            ...
            <a href="#gadget-populer" class="hover:text-white transition">Katalog</a>
            <a href="#cara-sewa" class="hover:text-white transition">Blog</a>
...
>
    ...
    <!-- Hero Section -->
    <section id="hero" class="relative bg-cover bg-center h-[580px] flex items-start px-6 md:px-16 pt-14" style="background-image: url('https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=2070&auto=format&fit=crop');">
        ...
        <div class="absolute inset-0 bg-gradient-to-r from-[#12141c] via-[#12141c]/85 to-[#12141c]/30"></div>
    ...
    <section id="cara-sewa" class="py-16 px-6 md:px-12 bg-[#12141c]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div id="tentang-kami">
                ...
                <div class="flex gap-2 mt-4">
                    <a href="#" class="w-8 h-8 rounded-lg bg-[#12141c] border border-gray-800 flex items-center justify-center text-gray-500 hover:text-pink-400 hover:border-pink-500/50 transition" title="Instagram">
                    ...
                    <a href="#" class="w-8 h-8 rounded-lg bg-[#12141c] border border-gray-800 flex items-center justify-center text-gray-500 hover:text-green-400 hover:border-green-500/50 transition" title="WhatsApp">
