...
<body class="bg-[#12141c] text-gray-300 min-h-screen flex flex-col justify-between antialiased">
    ...
    <footer class="bg-[#12141c] border-t border-gray-800/60 mt-20 pt-16 pb-8 px-4">
        <div class="max-w-6xl mx-auto space-y-12">
            ...
            <!-- Garis Batas Bawah & Sosial Media -->
            <div class="border-t border-gray-800/40 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-gray-500">
                <div>
                    &copy; 2026 GadgetRent. Semua hak dilindungi.
                </div>

                <!-- Sosial Media SVG Icons Moderen -->
                <div class="flex items-center space-x-2">
                    <!-- Instagram -->
                    <a href="#" class="w-7 h-7 bg-[#1a1d26] border border-gray-800 rounded-lg flex items-center justify-center hover:bg-[#222632] transition text-gray-400 hover:text-white">
                    ...
                    <!-- TikTok / Video App Custom Icon -->
                    <a href="#" class="w-7 h-7 bg-[#1a1d26] border border-gray-800 rounded-lg flex items-center justify-center hover:bg-[#222632] transition text-gray-400 hover:text-white">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5"></path>
                        </svg>
                    </a>
                    <!-- Chat / Support (WhatsApp/Live Chat Placeholder) -->
                    <a href="#" class="w-7 h-7 bg-[#1a1d26] border border-gray-800 rounded-lg flex items-center justify-center hover:bg-[#222632] transition text-gray-400 hover:text-white">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                        </svg>
